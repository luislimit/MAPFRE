 ...
 * @author federico
 */
public class FrmDefinicionNormas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblNormas.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "COD_NORMA", "DES_NORMA", "COD_USR", "FEC_ACTU"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmDefinicionNormas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmDefinicionNormas dialog = new FrmDefinicionNormas();
