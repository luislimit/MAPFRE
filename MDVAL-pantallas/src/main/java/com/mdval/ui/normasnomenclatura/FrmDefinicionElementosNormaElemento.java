 ...
 * @author federico
 */
public class FrmDefinicionElementosNormaElemento extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Definición de Elementos por Norma / Elemento");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmDefinicionElementosNormaElemento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmDefinicionElementosNormaElemento dialog = new FrmDefinicionElementosNormaElemento();
