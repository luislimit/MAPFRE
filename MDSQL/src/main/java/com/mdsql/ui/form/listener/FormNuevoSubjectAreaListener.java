 ...
 * @author LVARONA
 */
public class FormNuevoSubjectAreaListener extends ListenerSupport implements ActionListener{

    protected FormNuevoSubjectArea pantalla;

    public FormNuevoSubjectAreaListener(FormNuevoSubjectArea pantalla) {
    ...
    private void evtGuardar() {
        ...
        String codSubjectArea = pantalla.getTxtSubjectArea().getText();
        String desSubjectArea = pantalla.getTxtDescripcion().getText();        
        ...
        try {
            ...
            output = service.guardarSubjectArea(codProyecto, codSubjectArea, desSubjectArea, usuario);
