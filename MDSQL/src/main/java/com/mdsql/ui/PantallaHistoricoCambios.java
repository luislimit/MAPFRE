...
import com.mdsql.ui.renderer.CmbEstadoRenderer;
...
public class PantallaHistoricoCambios extends DialogSupport {
    ...
    @Getter
    private JComboBox<CodigoDescripcion> cmbOperacion;
    ...
    @Getter
    private JComboBox<CodigoDescripcion> cmbOperacionPadre;
    ...
    protected void initModels() {
        cmbEstadoScript.setRenderer(new CmbEstadoRenderer());
        cmbEstadoProcesado.setRenderer(new CmbEstadoRenderer());
        cmbTipoObjeto.setRenderer(new CmbStringRenderer());
        cmbTipoObjetoPadre.setRenderer(new CmbStringRenderer());
        cmbOperacion.setRenderer(new CmbCodigoDescripcionRenderer());
        cmbOperacionPadre.setRenderer(new CmbCodigoDescripcionRenderer());

        Cabecera cabecera = new TablaHistoricoObjetosCabecera();
