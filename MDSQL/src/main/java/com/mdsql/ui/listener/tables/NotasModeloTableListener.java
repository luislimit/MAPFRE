...
public class NotasModeloTableListener extends ListenerSupport implements ListSelectionListener {
    ...
    public void valueChanged(ListSelectionEvent e) {
        ...
        if (!Objects.isNull(seleccionado)) {
            ...
            pantallaMantenimientoNotasModelos.getTxtTitulo().setText(seleccionado.getTitulo());
            pantallaMantenimientoNotasModelos.getTxtDescripcion().setText(seleccionado.getDescripcion());
