...
public class DiagramasConsultaTableModel extends DefaultTableModel<TablasDiagrama> {
     ...
     * @param cabecera
     */
    public DiagramasConsultaTableModel(Cabecera cabecera) {
        super(cabecera);
    }
     ...
     * @param columnClasses
     */
    public DiagramasConsultaTableModel(List<String> columnNames, List<Class<?>> columnClasses) {
     ...
     * @param columnClasses
     */
    public DiagramasConsultaTableModel(List<TablasDiagrama> data, List<String> columnNames, List<Class<?>> columnClasses) {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
            ...
            case 1:
                return row.getCodSubjectArea();
            case 2:
                return row.getCodDiagrama();
            case 3:
