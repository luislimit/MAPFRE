 ...
 *
 */
public class PermisosObjetoTableModel extends DefaultTableModel<PermisoObjeto> {
     ...
     * @param cabecera
     */
    public PermisosObjetoTableModel(Cabecera cabecera) {
        super(cabecera);
    }
     ...
     * @param columnClasses
     */
    public PermisosObjetoTableModel(List<String> columnNames, List<Class<?>> columnClasses) {
     ...
     * @param columnClasses
     */
    public PermisosObjetoTableModel(List<PermisoObjeto> data, List<String> columnNames, List<Class<?>> columnClasses) {
        super(data, columnNames, columnClasses);
    }

    @Override
    public Object getValueAt(int rowIndex, int columnIndex) {
        PermisoObjeto row = data.get(rowIndex);
