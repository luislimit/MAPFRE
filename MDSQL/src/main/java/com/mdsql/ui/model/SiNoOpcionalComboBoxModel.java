 ...
 */
@Slf4j
public class SiNoOpcionalComboBoxModel extends AbstractListModel<String> implements ComboBoxModel<String> {
	 ...
	 * 
	 */
	public SiNoOpcionalComboBoxModel() {
		super();
		...
		try {
			...
			responses = new ArrayList<>();
                        responses.add(literales.getLiteral(""));
