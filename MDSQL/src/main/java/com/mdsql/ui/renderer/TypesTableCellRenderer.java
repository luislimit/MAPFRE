...
public class TypesTableCellRenderer extends DefaultTableCellRenderer {
	...
	public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus,
		...
		Type type = ((TypesTableModel) table.getModel()).getSelectedRow(row);
		
		if (!Objects.isNull(type)) {
			String descripcion = type.getDescripcionEstadoScript();
