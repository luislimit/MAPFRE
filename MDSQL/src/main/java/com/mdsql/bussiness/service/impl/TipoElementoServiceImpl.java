 ...
 * @author hcarreno
 */
@Service(MDSQLConstants.TIPO_ELEMENTO_SERVICE)
@Slf4j
public class TipoElementoServiceImpl extends ServiceSupport implements TipoElementoService {
    ...
    public TipoElemento consultarTipoElemento(BigDecimal codigoElemento) {
        String runSP = createCall("p_con_tipo_elemento", MDSQLConstants.CALL_06_ARGS);
    ...
    public List<TipoElemento> consultarTiposElementos(String descripcionElemento) {
        String runSP = createCall("p_con_tipos_elementos", MDSQLConstants.CALL_04_ARGS);

        try (Connection conn = dataSource.getConnection();
             CallableStatement callableStatement = conn.prepareCall(runSP)) {

            String typeTipoElemento = createCallType(MDSQLConstants.T_T_ELEMENTO);
            String typeError = createCallTypeError();
    ...
    public void altaTipoElemento(String descripcionElemento, String codigoUsuario) {
        String runSP = createCall("p_alta_tipo_elemento", MDSQLConstants.CALL_04_ARGS);
    ...
    public void modificarTipoElemento(BigDecimal codigoElemento, String descripcionElemento, String codigoUsuario) {
        String runSP = createCall("p_modificar_tipo_elemento", MDSQLConstants.CALL_05_ARGS);
