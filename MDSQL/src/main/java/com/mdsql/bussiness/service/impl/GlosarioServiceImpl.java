 ...
 * @author hcarreno
 */
@Service(MDSQLConstants.GLOSARIO_SERVICE)
@Slf4j
public class GlosarioServiceImpl extends ServiceSupport implements GlosarioService {
	...
	public List<Glosario> buscarGlosarios(String descripcionGlosario) {
		String runSP = createCall("p_buscar_glosarios", MDSQLConstants.CALL_04_ARGS);

		try (Connection conn = dataSource.getConnection();
				CallableStatement callableStatement = conn.prepareCall(runSP)) {

			String typeGlosario = createCallType(MDSQLConstants.T_T_GLOSARIO);
	...
	public Glosario consultarGlosario(BigDecimal codigoGlosario) {
		String runSP = createCall("p_consulta_glosario", MDSQLConstants.CALL_07_ARGS);
	...
	public void altaGlosario(String descripcionGlosario, String codigoUsuario) {
		String runSP = createCall("p_alta_glosario", MDSQLConstants.CALL_04_ARGS);
	...
	public void modificaGlosario(BigDecimal codigoGlosario, String descripcionGlosario, String codigoUsuario) {
		String runSP = createCall("p_modifica_glosario", MDSQLConstants.CALL_05_ARGS);
