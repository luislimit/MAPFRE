 ...
 * @author hcarreno
 */
@Service(MDSQLConstants.ELEMENTO_NORMA_SERVICE)
@Slf4j
public class ElementoNormaServiceImpl extends ServiceSupport implements ElementoNormaService {
    ...
    public List<ElementoNorma> consultarDefinicionElementoNorma(BigDecimal codigoNorma, BigDecimal codigoElemento) {
        String runSP = createCall("p_con_def_elem_norma", MDSQLConstants.CALL_05_ARGS);
        
        try (Connection conn = dataSource.getConnection();
             CallableStatement callableStatement = conn.prepareCall(runSP)) {
        	
            String typeError = createCallTypeError();
            String typeElementoNorma = createCallType(MDSQLConstants.T_T_ELEMENTO_NORMA);
    ...
    public List<ElementoNorma> consultarElementosNorma(BigDecimal codigoNorma) {
        String runSP = createCall("p_con_elem_norma", MDSQLConstants.CALL_04_ARGS);
