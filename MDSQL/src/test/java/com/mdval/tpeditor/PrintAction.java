...
/**
 * Clase que implementa la interface java.awt.print.Printable para imprimir el
 * documento presente en el área de edición.
 * 
 * @author Dark[byte]
 */
public class PrintAction implements Printable {
	...
	/**
	 * Le permite al usuario configurar algunos aspectos de la impresión antes de
	 * comenzar. Durante la impresión muestra una ventana de dialogo con información
	 * de la misma.
	 * 
	 * @param owner la ventana padre
	 * @return true si la impresión fue exitosa, false en caso contrario
	...
	public boolean printDialog(Frame owner) {
		...
		// establece a la clase PrintAction como responsable de renderizar las páginas
		// del documento
	 ...
	 * @return PAGE_EXISTS si la página se tiene que imprimir, NO_SUCH_PAGE si la
	 *         página no es valida
	 */
	@Override
	public int print(Graphics g, PageFormat pf, int pageIndex) {
		...
		if (pageBreaks == null) { // si los quiebres de página no fueron calculados
			...
			// calcula el número de quiebres de página necesarios para imprimir todo el
			// documento
		...
		// si el índice de página solicitado es menor o igual que la cantidad de
		// quiebres total
		if (pageIndex <= pageBreaks.length) {
			/**
			 * establece una igualdad entre el origen del espacio gráfico (x:0,y:0) y el
			 * origen del área imprimible definido por el formato de página
			 */
	...
	/**
	 * Clase interna que extiende javax.swing.JDialog para presentar una ventana
	 * modal de dialogo que muestra el estado de la impresión y un botón para
