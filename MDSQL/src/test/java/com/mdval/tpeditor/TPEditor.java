...
public class TPEditor {
	...
	public TPEditor() {
		...
		buildTextArea(); // construye el área de edición, es importante que esta sea la primera parte en
							// construirse
		...
		// configura el JFrame con un tamaño inicial proporcionado con respecto a la
		// pantalla
	...
	private void buildTextArea() {
		...
		// se configura por defecto para que se ajusten las líneas al tamaño del área de
		// texto ...
		...
		// JTextArea
		jTextArea.getInputMap().put(KeyStroke.getKeyStroke(KeyEvent.VK_X, ActionEvent.CTRL_MASK), "none"); // remueve
																											// CTRL + X
																											// ("Cortar")
		jTextArea.getInputMap().put(KeyStroke.getKeyStroke(KeyEvent.VK_C, ActionEvent.CTRL_MASK), "none"); // remueve
																											// CTRL + C
																											// ("Copiar")
		jTextArea.getInputMap().put(KeyStroke.getKeyStroke(KeyEvent.VK_V, ActionEvent.CTRL_MASK), "none"); // remueve
																											// CTRL + V
																											// ("Pegar")
	}
	...
	private void buildMenuBar() {
		...
		// construye el menú "Archivo", a continuación se construyen los items para este
		// menú
		...
		// construye el menú "Editar", a continuación se construyen los items para este
		// menú
		...
		// construye el menú "Opciones", a continuación se construyen los items para
		// este menú
		...
		// construye el menú "Ayuda", a continuación se construye el único item para
		// este menú
	...
	private void buildToolBar() {
		...
		/**
		 * itera sobre todos los componentes de la barra de herramientas, se les asigna
		 * el mismo margen y el mismo manejador de eventos unicamente a los botones
		 */
	...
	private void buildStatusBar() {
		...
		statusBar.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createLoweredBevelBorder(),
		...
		// construye la etiqueta para mostrar la posición del cursor en el documento
		// actual
	...
	class EventHandler extends MouseAdapter implements ActionListener, CaretListener, UndoableEditListener {
		...
		public void actionPerformed(ActionEvent ae) {
			...
			if (ac.equals("cmd_new") == true) { // opción seleccionada: "Nuevo"
				...
				JOptionPane.showMessageDialog(jFrame, "TextPad Demo por Dark[byte]", "Acerca de",
		...
		public void caretUpdate(CaretEvent e) {
			...
			try {
				// obtiene la posición del cursor con respecto al inicio del JTextArea (área de
				// edición)
				caretPos = jTextArea.getCaretPosition();
				// sabiendo lo anterior se obtiene el valor de la línea actual (se cuenta desde
				// 0)
				...
				// al valor de la línea actual se le suma 1 porque estas comienzan contándose
				// desde 0
				y += 1;
			...
			/**
			 * muestra la información recolectada en la etiqueta sbCaretPos de la barra de
			 * estado, también se incluye el número total de lineas
			 */
